# TD4 Assembler
Future version of TD4 Assembler 2.
## Index
- [Index](#index)
...
## Description
This repository hosts the upgraded 2nd version of TD4 Assembler. Here are some features:
...
```bash
git clone https://github.com/Nekhaevalex/TD4-Assembler
cd TD4-Assembler/TD4\ Assembler
make compile
```
## Usage
### Instructions
...
Also you can use ```new_project.sh``` script for making new project:
```bash
